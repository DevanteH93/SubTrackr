        ...
        <section>
            ...
            <form onSubmit={handleFormSubmit}>
                <label>
                    ...
                    <input value={formData.name} onChange={handleChangeInput} type="text" name="name" placeholder="e.g. Netflix, Spoyify, AWS Hosting" required />
                </label>
                ...
                <label>
                    ...
                    <select value={formData.status} onChange={handleChangeInput} name="status">
                        {['Active', 'Paused', 'Canceled'].map((cur, curIndex) =>{
                            return (
                                <option key={curIndex}>{cur}</option>
                            )
                        })}
                ...
                <label value={formData.notes} onChange={handleChangeInput} className="fat-column">
                    <span>Notes</span>
